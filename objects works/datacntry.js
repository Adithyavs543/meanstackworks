...
// data.forEach(cntry=>console.log(cntry.name.common))
// data.forEach(cntry=>console.log(cntry.population))

// data.forEach(cntry=>console.log(cntry.currencies))



//JSON(Javascript Object Notation)->how data transfer,Xml
// Array,Object->

var cty=data.map(cntry=>cntry.currencies)
console.log(cty);